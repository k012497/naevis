...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = `./assets/projects/${/*image*/ ctx[7]}`)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", img_alt_value = /*image*/ ctx[7]);
    			attr_dev(img, "class", "svelte-x4vfo6");
    			add_location(img, file$2, 11, 4, 249);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*images*/ 8 && !src_url_equal(img.src, img_src_value = `./assets/projects/${/*image*/ ctx[7]}`)) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*images*/ 8 && img_alt_value !== (img_alt_value = /*image*/ ctx[7])) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "tag svelte-x4vfo6");
    			add_location(div, file$2, 15, 2, 348);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*tags*/ 4 && t_value !== (t_value = /*tag*/ ctx[4] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "title svelte-x4vfo6");
    			add_location(div0, file$2, 7, 2, 129);
    			attr_dev(div1, "class", "desc");
    			add_location(div1, file$2, 8, 2, 164);
    			attr_dev(div2, "class", "image svelte-x4vfo6");
    			add_location(div2, file$2, 9, 2, 197);
    			attr_dev(div3, "class", "project-item svelte-x4vfo6");
    			add_location(div3, file$2, 6, 0, 100);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	return [title, desc, tags, images];
    }

    class ProjectItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { title: 0, desc: 1, tags: 2, images: 3 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "project-title svelte-qv6ros");
    			add_location(div0, file$1, 4, 2, 111);
    			attr_dev(div1, "class", "project-container svelte-qv6ros");
    			add_location(div1, file$1, 3, 0, 77);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, div0);
    			append_dev(div1, t1);
    			mount_component(projectitem0, div1, null);
    			append_dev(div1, t2);
    			mount_component(projectitem1, div1, null);
    			append_dev(div1, t3);
    			mount_component(projectitem2, div1, null);
    			current = true;
    		},
    		p: noop,
