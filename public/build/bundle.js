    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(figure0, "class", "floating-object title svelte-15hhtny");
    			...
    			attr_dev(span0, "class", "svelte-15hhtny");
    			add_location(span0, file$1, 36, 6, 1144);
    			if (!src_url_equal(img0.src, img0_src_value = "./assets/person.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "person");
    			attr_dev(img0, "class", "svelte-15hhtny");
    			add_location(img0, file$1, 37, 6, 1171);
    			attr_dev(figure1, "class", "floating-object person svelte-15hhtny");
    			...
    			attr_dev(img1, "class", "svelte-15hhtny");
    			add_location(img1, file$1, 40, 6, 1317);
    			attr_dev(figure2, "class", "floating-object star svelte-15hhtny");
    			add_location(figure2, file$1, 39, 4, 1234);
    			if (!src_url_equal(img2.src, img2_src_value = "./assets/plant.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "plant");
    			attr_dev(img2, "class", "svelte-15hhtny");
    			add_location(img2, file$1, 43, 6, 1461);
    			attr_dev(figure3, "class", "floating-object plant svelte-15hhtny");
    			add_location(figure3, file$1, 42, 4, 1376);
    			if (!src_url_equal(img3.src, img3_src_value = "./assets/computer.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "computer");
    			attr_dev(img3, "class", "svelte-15hhtny");
    			add_location(img3, file$1, 46, 6, 1618);
    			attr_dev(span1, "class", "svelte-15hhtny");
    			add_location(span1, file$1, 47, 8, 1675);
    			attr_dev(figure4, "class", "floating-object computer svelte-15hhtny");
    			add_location(figure4, file$1, 45, 4, 1522);
    			attr_dev(div1, "class", "universe-surface svelte-15hhtny");
    			add_location(div1, file$1, 29, 2, 863);
    			attr_dev(div2, "class", "universe-container svelte-15hhtny");
